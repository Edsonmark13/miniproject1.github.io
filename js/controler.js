...
let testimonials = [
  ...
  'I have tried many different websites to learn html and javascript, but LearnFast by far is the easiest. The design is clean and the examples are easy to follow. I love that you can see your progress on the site, so you know when you are ready for a new challenge.',
  "I've tried every css and html tutorial website there is and I just couldn't seem to find the one that worked for me. I am so happy that I found LearnFast.com it is a friendly website with great examples, but it also has all the tutorials you will ever need all in one spot!"
];
function getUsers() {
    fetch("https://randomuser.me/api/?results=3")
      ...
      .then((data) => {
        ...
        for(let i = 0; i < data.results.length; i++){
            ...
            testimonialContainerItems+='    <p class="px-5 lead">' + testimonials[i] +'<br><span class="fs-6">- <b>'+ data.results[i].name.title + '. ' + data.results[i].name.first + " " + data.results[i].name.last+'</b></span></p>';
